...
const DEFAULT_STATS_Y_OFFSET: f32 = 80.0;
...
fn show_player_stats(players: &Vec<Player>) {
    for player in players.iter() {
        ...
        draw_text(
            ...
            position.x - 20.0,
            position.y - DEFAULT_STATS_Y_OFFSET,
        ...
        draw_text(
            ...
            position.x - 20.0,
            position.y - DEFAULT_STATS_Y_OFFSET + 20.0,
            DEFAULT_STATS_FONT_SIZE,
            BLACK,
        );
        draw_text(
            ...
            position.x - 20.0,
            position.y - DEFAULT_STATS_Y_OFFSET + 40.0,
            DEFAULT_STATS_FONT_SIZE,
            BLACK,
        );
    }
...
fn add_ball(balls: &mut Vec<Ball>, ball_position: Vec2, ball_type: BallTypes) {
    let ball_to_add = Ball::new(ball_position, ball_type);
